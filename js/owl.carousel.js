...
;(function($, window, document, undefined) {
     ...
     * @public
     * @param {Owl.Width} [dimensions=Owl.Width.Deafult] - The dimension to return.
    ...
    Owl.prototype.registerEventHandlers = function() {
        ...
        if (this.settings.mouseDrag) {
            this.$element.addClass(thi.options.dragClass);
    ...
    Owl.prototype.onDragStart = function(event) {
        ...
        if (this.is('animating')) {
            $.support.transform ? this.animated(stage.x) : this.$stage.stop()
    ...
    Owl.prototype.leave = function(name) {
        $.each([ name ].concat(this._states[name] || []), $.proxy(function(i, name) {
            this._states.current[name]--;
        }, this));
    };
     ...
     * @returns {Object} - Contains 'x' and 'y' coordinates of current point position.
     */
            ...
            'initialized.owl.carousel change.owl.carousel resized.owl.carousel': $.proxy(function(e) {
                ...
                if ((e.property && e.property.name === 'position') || e.type == 'initialized') {
                    ...
                    while (i++ < n) {
                        ...
                        clones && $.each(this._core.clones(this._core.relative(positions)), load);
                        position++;
                    }
                }
            }, this)
...
;(function($, window, document, undefined) {
    ...
    var Video = function(carousel) {
        ...
        /**
         * All event handlers.
         * @todo The cloned content removal is too late.
         * @protected
         * @type {Object}
         */
        this._handlers = {
...
;(function($, window, document, undefined) {
    ...
    /**
     * Toggles the animation classes whenever a translation starts.
     * @protected
    ...
    Animate.prototype.destroy = function() {
        ...
        for (handler in this.handlers) {
            thi.core.$element.off(handler, this.handlers[handler]);
        }
        for (property in Object.getOwnPropertyNames(this)) {
            typeof this[property] != 'function' && (thi[property] = null);
        }
    };
        ...
        this._handlers = {
            'changed.owl.carousel': $.proxy(function(e) {
                if (e.namespace && e.property.name === 'settings') {
                    ...
                    // Reset the timer. Thi code is triggered when the position
...
;(function($, window, document, undefined) {
    ...
    var Navigation = function(carousel) {
        ...
        /**
         * All DOM element of the user interface.
         * @protected
         * @type {Object}
         */
        this._controls = {};
    ...
    Navigation.prototype.initialize = function() {
        ...
        this._controls.$absolute = (settings.dotsContainer ? $(settings.dotsContainer)
            : $('<div>').addClass(setings.dotsClass).appendTo(this.$element)).addClass('disabled');
    ...
    Navigation.prototype.destroy = function() {
        ...
        for (override in this.overrides) {
            this._core[override] = this.overrides[override];
        }
        for (property in Object.getOwnPropertyNames(this)) {
            typeof this[property] != 'function' && (this[property] = null);
        }
    ...
    Navigation.prototype.to = function(position, speed, standard) {
        ...
        if (!standard && this._pages.length) {
            length = this._pages.length;
            $.proxy(this.overrides.to, this._core)(this._pages[((position % length) + length) % length].start, speed);
        } else {
