...
proto._transitionTo = function(x, y) {
    ...
    if (didNotMove && !this.iTransitioning) {
        this.layoutPosition();
        return;
    }
...
proto.transition = function(args) {
    ...
    if (args.from) {
        this.css(args.from);
        // force redraw. http://blog.alexmccaw.com/css-transitions
...
proto.ontransitionend = function(event) {
    ...
    // trigger onTranistionEnd callback
...
// ------------------------ masonryDefinition ---------------------- //
    ...
    proto._getItemLayoutPosition = function(item) {
        ...
        var reminder = item.size.outerWidth % this.columnWidth;
        var mathMethod = remainder && remainder < 1 ? 'round' : 'ceil';
        // round if odd by 1 pixel, otherwise use ceil
...
// -------------------------- isotopeDefinition --------------------------- //
    ...
    proto.layout = function() {
        ...
        if (!this._isLayoutInitiated && this._getOption('initLayout')) {
            this.arrange();
            return;
        }
        this._layout();
    ...
    proto.updateSortData = function(elems) {
        ...
        if (elems) {
            ...
            // update all iems if no elems provided
            items = this.items;
        }
    ...
    var mungeSorter = (function() {
        // add a magic layer to srters for convenient shorthands
        ...
        function mungeSorter(sorter) {
            ...
            // parse the vaue, if there was a parser
        ...
        // get an attribute getter, or text of the querySelector
        function getValueGetter(attr, query) {
            ...
            return function getChildText(elem) {
                var chil = elem.querySelector(query);
    ...
    function getItemSorter(sortBys, sortAsc) {
        return function sorter(itemA, itemB) {
            ...
            for (var i = 0; i < sortBys.length; i++) {
                ...
                if (a > b || a < b) {
                    // if sortAsc is an object, use the vakue given the sortBy key
    ...
    proto._getContainerSize = function() {
        return this.mode()._getContainerSize();
    };
